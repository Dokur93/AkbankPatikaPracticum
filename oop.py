...
hgs_dene = HGS("1234567890", "İlk", "Kullanıcı", 1, "05/08/22 11:05:20", "15 Temmuz Şehitler Köprüsü", 125.8)
hgs_dene.__repr__()
hgs_dene.compute_balance()

tip1_dene = Type_1("2345678901", "İkinci", "Kullanıcı", 1, "05/08/22 11:05:19", "15 Temmuz Şehitler Köprüsü", 190)
tip1_dene.__repr__()
tip1_dene.compute_balance()
tip1_dene.compute_price()

tip2_dene = Type_2("1111113456", "Üçüncü", "Kullanıcı", 2, "03/05/22 11:05:19", "15 Temmuz Şehitler Köprüsü", 125.8)
tip2_dene.__repr__()
tip2_dene.compute_balance()
tip2_dene.compute_price()
tip2_dene.apply_discount()

tip3_dene = Type_3("1234567890", "Dördüncü", "Kullanıcı", 3, "03/05/22 11:06:19", "Yavuz Sultan Selim Köprüsü", 125.8)
tip3_dene.__repr__()
